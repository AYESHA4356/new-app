  ...
  return (
    <div className='logo'>
      <div className='container justify-between flex items-center'>
        ...
        <div className='flex gap-4 mr-[25px] items-center h-[40px] mt-[10px] ml-5 px-[22px]  border-none'>
          ...
          <div ref={cartRef} className='relative'>
            <FaShoppingCart onClick={toggleCart} className="cart-icon cursor-pointer" />
            <div className={`cart-page ${isOpen ? 'open' : ''}`}>
              <div className="flex items-center my-5">
                <h3 className='mx-9 text-2xl font-semibold'>Cart</h3>
                <RxCross2 className='ml-40 text-2xl font-semibold cursor-pointer cross' onClick={toggleCart} />
              </div>
              <div className="flex gap-6 mx-9 my-5 mb-3.5 py-6">
                <img src="./imges/1 (3).png" className='h-16 w-16' alt="image" />
                <p className='text-sm font-semibold text-gray-600 cart_para'>
                  GenRoar plain T shirt color <br /> black & navy blue which <br /> is of only 400 Rs
                </p>
              </div>
